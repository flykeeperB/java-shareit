...
public class ItemController {
    ...
    @GetMapping
    public List<ItemExtraDto> retrieveForOwner(@RequestParam(defaultValue = "0") Integer from,
    ...
    @GetMapping("/search")
    public List<ItemDto> retrieveAvailableForSearchText(@RequestParam(defaultValue = "0") Integer from,
                                                        @RequestParam(defaultValue = "15") Integer size,
