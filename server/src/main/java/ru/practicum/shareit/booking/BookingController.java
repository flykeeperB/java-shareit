...
public class BookingController {
    ...
    public BookingExtraDto create(@RequestBody BookingExtraDto bookingDto,
    ...
    @GetMapping
    public List<BookingExtraDto> retrieveForBooker(@RequestParam(defaultValue = "0") Integer from,
    ...
    @GetMapping("/owner")
    public List<BookingExtraDto> retrieveForItemsOwner(@RequestParam(defaultValue = "0") Integer from,
                                                       @RequestParam(defaultValue = "15") Integer size,
                                                       @RequestParam(name = "state",
                                                               required = false,
                                                               defaultValue = "ALL") String state,
